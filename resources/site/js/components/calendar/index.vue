<template>
    <div class="calendar-month" v-if="dataReady">
        ...
        <ul class="days-grid">
            ...
            <div style="font-weight: bold; font-size: 17px; color:red;">
...
export default {
    ...
    methods: {
        ...
        getCurrentDate() {
            //this.$root.api_url
            axios.get( this.$root.api_url + '/api/get-current-date')
                .then((response) => {
        ...
        getStartTime() {
            axios.get(this.$root.api_url +'/api/settings/get-start-time')
                .then((response) => {
        ...
        getEventDates() {
            axios.get(this.$root.api_url + '/api/event-dates', {params: {'start': this.days[0]['date'], end: this.days[this.days.length - 1]['date']}})
                .then((response) => {
