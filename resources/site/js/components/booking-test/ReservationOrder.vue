    ...
    <div>
        ...
        <form>
            <div class="reservation-form__group">
                <div class="alert alert-danger" role="alert" v-if="errors.has('reservation')" v-text="errors.get('reservation')" style="word-wrap: break-word; word-break: normal;"></div>
...
export default {
    ...
    methods: {
        submitForm() {
            axios.post(this.$root.api_url + '/api/order-test', {client:this.form, reservation:this.reserveData, reservations:this.reservations})
            .then((response) => {
