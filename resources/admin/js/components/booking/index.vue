    ...
    <div class="booking__wrap">
        <section class="booking">
            ...
            >
                <div slot="title"> </div>
                <reservation-order
                    @close-reserve-modal="makeReservation"
                    :reserve-data="reserveData"
...
<script>
    ...
    export default {
     components: {
        ...
        methods: {
         testEmail() {
            axios.post('/admin/api/test-email');
         },
         makeReservation() {
             this.orderModalVisible=false;
             this.firstStep = false;
             this.canSelectMap = false;
             this.reservations = [];
             this.selectedPlacesArrFirst = [];
             this.selectedPlacesArrSecond = [];
             this.selectedCabinsArr = [];
             this.reserveData =  {
                 selectedDay:null,
                     selectedDayString:'',
                     startTime:'',
